// Griddy — ASCII diagram/dataflow editor
// Split from the original single-file index.html into griddy.html / styles.css / app.js
(function(){
  ...
  // Image import state
  let importedImageData = null; // { ascii, width, height, charMatrix }
